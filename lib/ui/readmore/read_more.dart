...
class JackReadMoreText extends StatefulWidget {
  ///
  /// For every ReadMoreText create Valuenotifier boolean
  /// ```
  /// final readMore = ValueNotifier(true);
  /// ```
  const JackReadMoreText(
    this.data,
    this.readMore, {
    Key? key,
    this.preDataText,
  ...
  /// read more state
  final ValueNotifier<bool> readMore;
  ...
  @override
  JackReadMoreTextState createState() => JackReadMoreTextState();
}
...
class JackReadMoreTextState extends State<JackReadMoreText> {
  // bool _readMore = true;
  bool _readMore = true;

  @override
  void initState() {
    widget.readMore.addListener(() {
      setState(() {
        _readMore = widget.readMore.value;
      });
    });
    super.initState();
  }
  ...
  void _onTapLink() {
    setState(() {
      final value = !_readMore;
      widget.readMore.value = value;
      _readMore = !_readMore;
